        ...
        return(
            <div id="indexApp">
                ...
                <div id="centerContent">
                    ...
                    <p className="centerText" id="main">We provide many different services and can help you.</p>
                    <p className="centerText" id="stats">Our customers see an average of:</p>
                    <img id="img2" className="img"  src="/common/images/13122-01-data-driven-infographic-16x9-1.jpg" alt="good chart"></img>
                    <p className="centerText" id="stats2">5000x more purchases, 90000x more return customers, and an average life expectancy of 35000 years</p>
                    <img id="img3" className="img"  src="/common/images/th-2380061417.jpg" alt="chart 2"></img>
                    <p className="centerText" id="thumbsuptext">Contact Us Today for a Free quote</p>
