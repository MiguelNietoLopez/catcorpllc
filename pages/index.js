        ...
        return(
            <div id="indexApp">
                ...
                <div id="centerContent">
                    ...
                    <img id="img1" src="common/images/business-cat-in-office.jpg" alt="Cat Corp LLC banner image"></img>
                    <p id="main">We provide many different services and can help you.</p>
                    <p id="stats">Our customers see an average of:</p>
                    <img id="img2" src="/common/images/13122-01-data-driven-infographic-16x9-1.jpg" alt="good chart"></img>
